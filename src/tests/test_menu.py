"""Module providing test to ensure the menu movements, category, balance."""

import datetime
from src.menu import process_movement, add_new_category, remove_category

def test_income_increase_balace():

    """Function test to ensure the balance increase 
        when recibe a income parameter."""
...
def test_expense_decrease_balance():
    ...
    """Function test to ensure the balance decrease 
        when recibe a expense parameter."""
...
def test_add_new_category():
    ...
    "Function test to ensure correctly add a new category."
